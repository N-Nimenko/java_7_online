...
public class ChiefStorage {
    ...
    public void readChiefsFromJson() {
        Gson gson = new Gson();
        try (FileReader fileReader = new FileReader("C:/Users/User/Desktop/Projects/Homework/homework10/json/chiefs.json")) {
    ...
    public void writeChiefsToJson() {
        Gson gson = new Gson();
        try (FileWriter fileWriter = new FileWriter("C:/Users/User/Desktop/Projects/Homework/homework10/json/chiefs.json")) {
