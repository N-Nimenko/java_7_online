...
public class RestaurantStorage {
    ...
    public void readRestaurantsFromJson() {
        Gson gson = new Gson();
        try (FileReader fileReader = new FileReader("C:/Users/User/Desktop/Projects/Homework/homework10/json/restaurants.json")) {
    ...
    public void writeRestaurantsToJson() {
        Gson gson = new Gson();
        try (FileWriter fileWriter = new FileWriter("C:/Users/User/Desktop/Projects/Homework/homework10/json/restaurants.json")) {
