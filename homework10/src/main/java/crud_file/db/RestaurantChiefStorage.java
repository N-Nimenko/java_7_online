...
public class RestaurantChiefStorage {
    ...
    public void readRestaurantChiefsFromJson() {
        Gson gson = new Gson();
        try (FileReader fileReader = new FileReader("C:/Users/User/Desktop/Projects/Homework/homework10/json/restaurantchief.json")) {
    ...
    public void writeRestaurantChiefsToJson() {
        Gson gson = new Gson();
        try (FileWriter fileWriter = new FileWriter("C:/Users/User/Desktop/Projects/Homework/homework10/json/restaurantchief.json")) {
